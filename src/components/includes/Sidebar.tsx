    ...
    <>
      <nav
        className={classNames(
          "fixed top-0 left-0 h-full pb-10 overflow-x-hidden overflow-y-auto transition duration-300 origin-left transform bg-white border-r border-gray-100 -translate-x-full",
          className
        )}
      >
